/***************************
@Name：喵喵ios 签到 积分可以兑换苹果付费应用账号
@Author：Sliverkiss
@Date：2023-10-10 12:17:56
适配修改：松鼠ios→喵喵iOS www.mmios.net
...
class UserInfo {
    ...
    async nonce() {
        try {
            ...
            //⚠️重点！如果抓包发现喵喵页面nonce正则不匹配，你需要在这里替换正则！
